$(document).ready(function() {
    ...
    function imageDisplay(response) {
        ...
        if (response.weather[0].main == "Rain" && response.weather[0].icon.includes("d")) {
            ...
            $('body').css('background-image', 'url(http://il1.picdn.net/shutterstock/videos/8739574/thumb/1.jpg?i10c=img.resize(height:160))');
            $(".firstImg").attr("src", "https://cdn.iconscout.com/icon/free/png-256/haze-air-mist-weather-wind-38962.png");
            ...
            $('body').css('background-image', 'url(http://il1.picdn.net/shutterstock/videos/8739574/thumb/1.jpg?i10c=img)');
            $(".firstImg").attr("src", "https://cdn.iconscout.com/icon/free/png-256/haze-air-mist-weather-wind-38962.png");
        } else if (response.weather[0].main == "Rain" && response.weather[0].icon.includes("n")) {
            $(".firstImg").attr("src", "images/rainyDay.svg");
            $('body').css('background-image', 'url(http://www.freevector.com/site_media/preview_images/FreeVector-Rain-Background.jpg)');
